...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 38.0, 131.0, 78.0, 22.0 ],
					"text" : "fftout~ 1 nofft"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 38.0, 45.0, 45.0, 22.0 ],
					"text" : "fftin~ 1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 74.0, 479.0, 283.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 510.0, 14.0, 28.0, 22.0 ],
									"text" : "in 3"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 55.0, 377.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 38.0, 94.0, 125.0, 22.0 ],
					"text" : "gen~"
				}
